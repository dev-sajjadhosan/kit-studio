...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        'focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex cursor-default items-center rounded-sm px-2 py-1.5 text-xs [&_svg]:size-4 [&_svg]:text-muted-foreground gap-2 outline-hidden select-none data-[inset]:pl-8',
        className,
      )}
      {...props}
    >
